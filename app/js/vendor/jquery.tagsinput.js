    ...
    var settings = jQuery.extend({
      ...
      inputPadding: 6*2
		...
		this.each(function() { 
			...
			// 	markup = markup + '<input id="'+id+'_tag" class="search-input" value="" placeholder="'+settings.defaultText+'" />';
			// }
			...
			$(data.fake_input).bind('focus', data, function(event) {
				$(data.holder).css('border-color', '#3498db');	
			});
			$(data.fake_input).bind('blur', data, function(event) {
				$(data.holder).css('border-color', '#95a5a6');
			});
